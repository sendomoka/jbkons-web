...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-30 w-full bg-white shadow text-black text-sm p-3 md:px-20 flex flex-row">
            <div>
                <Link href='/'>
                <Image src='/logo.png' width={136} height={37} alt='Logo JBKons PT JOGLOMAS BRILIAN KONSULTAN'/>
                </Link>
            </div>            
            <nav className="hidden md:mr-auto md:ml-4 md:pt-2 md:pl-3 md:border-l md:border-gray-400 flex-wrap md:block items-center text-sm text-zinc-600 font-medium justify-center">
                <ul className="flex">
                    ...
                    <li key={index}>
                        <Link href={menu.href} className="py-3 px-4 hover:text-black hover:bg-zinc-100 rounded-sm">
                        {menu.text}
                        </Link>
                    </li>
                    ))}
            ...
            <a href="/COMPANY PROFILE JBKONS 2023-1-36.pdf" download>
                <button className='hidden md:inline-flex items-center group py-2 px-4 text-zinc-600 hover:text-black border hover:border-black hover:bg-zinc-100 rounded-lg'>
                    Unduh CP
            ...
            <Link href='https://wa.me/6282225314338' target='_blank'>
                <button className='hidden md:inline-flex items-center group py-2 px-4 ml-3 text-white hover:text-zinc-300 border border-zinc-900 hover:border-zinc-700 bg-zinc-900 hover:bg-zinc-700 rounded-lg'>
                    Mari Bangun Bersama
            ...
            <div className='inline-flex md:hidden ml-auto'>
                <a href="/COMPANY PROFILE JBKONS 2023-1-36.pdf" download>
                    <button className='inline-flex md:hidden items-center group pt-[9.5px] pb-[9.5px] px-3 mt-1 ml-8 text-xs text-zinc-600 hover:text-black border hover:border-black hover:bg-zinc-100 rounded-lg'>
                    Unduh CP
                        <Image src='/unduh-black-thick.png' width={14} height={14} alt='' className='ml-1 opacity-60 group-hover:opacity-100'/>
                    </button>
                </a>
                <Link href='https://wa.me/6282225314338' target='_blank'>
                    <button className='inline-flex md:hidden items-center group pt-[9.5px] pb-[9.5px] px-3 mt-1 ml-1 text-xs text-white hover:text-zinc-300 border border-zinc-900 hover:border-zinc-700 bg-zinc-900 hover:bg-zinc-700 rounded-lg'>
                    Ayo Bangun
