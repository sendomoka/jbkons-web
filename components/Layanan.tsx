    ...
    return (
        ...
        <div className="container px-5 py-24 mx-auto">
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <img src='https://i.ibb.co/sqjGbJS/consulting.png' width={55} height={55} alt='' draggable='false' className='mx-auto mb-3'/>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                <img src='https://i.ibb.co/CtBxGCF/architect.png' width={55} height={55} alt='' draggable='false' className='mx-auto mb-3'/>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                <img src='https://i.ibb.co/ZgKm5t9/khusus.png' width={55} height={55} alt='' draggable='false' className='mx-auto mb-3'/>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                <img src='https://i.ibb.co/TcLbGXC/dump-truck.png' width={55} height={55} alt='' draggable='false' className='mx-auto mb-3'/>
